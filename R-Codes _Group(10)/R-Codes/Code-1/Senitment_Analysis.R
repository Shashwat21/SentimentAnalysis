...
setwd("C:\\Users\\Varsha Holennavar\\Desktop\\sentiment analysis\\R-Codes\\Code-1")
...
search <- function(searchterm)
{
  ...
  pos <- scan('C:\\Users\\Varsha Holennavar\\Desktop\\sentiment analysis\\R-Codes\\Code-1\\positive-words.txt', what='character', comment.char=';') #folder with positive dictionary
